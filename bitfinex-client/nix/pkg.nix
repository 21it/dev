...
, memory, parallel, persistent, siggy-chardust, singletons
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    http-types lens-aeson memory parallel persistent siggy-chardust
    singletons singletons-base template-haskell text time transformers
    units universum unliftio vector witch
  ];
